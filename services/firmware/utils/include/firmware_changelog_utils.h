...
#ifndef FIRMWARE_CHANGELOG_UTILS_H
#define FIRMWARE_CHANGELOG_UTILS_H
...
public:
    std::string GetChangelogDir();

    std::vector<std::string> GetNewVersionComponentIds();
    std::vector<std::string> GetCurrentVersionComponentIds();
