...
#include "GetUpgradeStatus_fuzzer.h"
...
namespace OHOS {
    ...
    int32_t FuzzUpdateServiceGetUpgradeStatusImpl(UpdateContext &ctx, UpdateCallbackInfo &cb,
    ...
    bool FuzzUpdateServiceGetUpgradeStatus(const uint8_t* data, size_t size)
    {
        ...
        return !FuzzUpdateServiceGetUpgradeStatusImpl(ctx, cb, policy, versionInfo, service, info);
    }
}
