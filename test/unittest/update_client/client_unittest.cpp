...
public:
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_GET_UPDATER;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_CHECK_VERSION;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_DOWNLOAD;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_UPGRADE;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_SET_POLICY;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_GET_POLICY;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_GET_NEW_VERSION;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_GET_STATUS;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_APPLY_NEW_VERSION;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_REBOOT_AND_CLEAN;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_VERIFY_PACKAGE;
        g_testEnv.testAsyncorPermose = isPormise;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_SUBSCRIBE;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_UNSUBSCRIBE;
        g_testEnv.testAsyncorPermose = isPormise;
        g_testEnv.eventType = eventType;
    ...
    {
        g_testEnv.testStage = (int32_t)SessionType::SESSION_CANCEL_UPGRADE;
